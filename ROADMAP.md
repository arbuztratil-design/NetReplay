...
- [ ] #1 Унифицировать версию проекта — один источник версии для `pyproject`, Python-пакета и API.
- [ ] #2 Почистить корень репозитория — вынести экспериментальные `_*.py` в `tools/` или удалить.
